...
PreparedStatement ps = conn.prepareStatement("Update msfoods_items SET name=?,Intro=?,price=?,file=?,c1=?,c2=?,qt=?,text=?,img1=?,img2=?,img3=?,img4=?,img5=?,img6=?,sell=? where id='"+id+"'");
ps.setString(1,name);
