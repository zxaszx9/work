	...
	<main>
		...
		<div class="item">		
            ...
            <tr>
				<c:forEach var="row" items="${result.rows}" varStatus="status">					
				   <c:if test="${(status.index) < 6}">
						 <td style="font-weight:bold;text-align:center;padding:1%;"><button style="height:30px;width:30%;font-size: 15px;border-color: #99DE99;background-color: #99DE56; border-radius: 30px;">購買</button></td>
				   </c:if>
				</c:forEach>
			</tr>
			<tr>
